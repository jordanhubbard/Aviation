...
import sys
import os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '../../..', 'packages/shared-sdk/python'))
...
class GoogleCalendarService:
    ...
    def update_event(self, event_id: str, booking: Booking, user: User) -> Optional[str]:
        """
        ...
        try:
            ...
            updated_event = self.client.update_event(event_id, event, calendar_id='primary')
