...
/**
 * Convert TelemetrySnapshot to FlightState for plugins
 */
export function telemetryToFlightState(telemetry: TelemetrySnapshot): FlightState {
  return {
    position: {
      latitude: telemetry.position.latitude_deg,
      longitude: telemetry.position.longitude_deg,
      altitude: telemetry.position.altitude_ft,
    },
    heading: telemetry.attitude.heading_deg,
    speed: telemetry.velocity.airspeed_kt,
    verticalSpeed: telemetry.velocity.vertical_speed_fpm,
