...
When using the responsible-vibe-mcp server, call `whats_next()` after each user message to get phase-specific instructions and maintain the development workflow.
